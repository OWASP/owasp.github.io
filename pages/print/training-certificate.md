...
// example url: https://owasp.org/pages/print/training-certificate?name=Mike%20McCamon&event=Virtual%20AppSec%20Days&class=Defending%20Kubernetes&sku=sku_HOts6ZxZnmJERL&hours=8&date=June%2020,%202020
  ...
  hstr = "<p style='font-size:24px;margin-left: 8px;'><span style='font-weight:bold;margin-right:8px;'>Course Title:</span><span style='font-style:italic;'>" + jtraining + "</span></p>";
  ...
  hstr += "<p style='font-size:18px'>Completed on " + jdate + " at " + jevent + " for a total of " + jhours + " hours of Continuing Education Credits<br>Course ID:" + jsku + "</p>";
