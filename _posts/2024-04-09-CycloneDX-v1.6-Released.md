...
As quantum computers are getting more mature, at some point in the future they are expected to break many currently used cryptographic algorithms, such as RSA. To address the issue, companies and organizations are urged to migrate their cryptographic assets to new post-quantum cryptographic algorithms to protect critical data and systems.
...
OWASP and the CycloneDX community would like to thank IBM Research for leading the CBOM initiative.

"The introduction of our CBOM in CycloneDX 1.6 is a significant milestone for managing the cryptography supply chain," said Michael Osborne, CTO of IBM Quantum Safe. "CBOM is the first open standard to describe an organizations’ cryptographic assets inventory, and their dependencies, allowing organizations to get hitherto unknown visibility into the cryptography they use, enabling them to assess their quantum readiness, and to take actionable steps towards becoming quantum safe."
